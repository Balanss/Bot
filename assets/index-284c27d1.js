 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nN=()=>tN().__FIREBASE_DEFAULTS__,rN=()=>{if(typeof process>"u"||typeof process.env>"u")return;const t={}.__FIREBASE_DEFAULTS__;if(t)return JSON.parse(t)},iN=()=>{if(typeof document>"u")return;let t;try{t=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=t&&d0(t[1]);return e&&JSON.parse(e)},Ah=()=>{try{return nN()||rN()||iN()}catch(t){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${t}`);return}},sN=t=>{var e,n;return(n=(e=Ah())===null||e===void 0?void 0:e.emulatorHosts)===null||n===void 0?void 0:n[t]},oN=t=>{const e=sN(t);if(!e)return;const n=e.lastIndexOf(":");if(n<=0||n+1===e.length)throw new Error(`Invalid host ${e} with no separate hostname and port!`);const r=parseInt(e.substring(n+1),10);return e[0]==="["?[e.substring(1,n-1),r]:[e.substring(0,n),r]},f0=()=>{var t;return(t=Ah())===null||t===void 0?void 0:t.config},aN=t=>{var e;return(e=Ah())===null||e===void 0?void 0:e[`_${t}`]};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qr=gD;function Tg(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:Vr,automaticDataCollectionEnabled:!1},e),i=r.name;if(typeof i!="string"||!i)throw jn.create("bad-app-name",{appName:String(i)});if(n||(n=f0()),!n)throw jn.create("no-options");const s=Or.get(i);if(s){if(bc(n,s.options)&&bc(r,s.config))return s;throw jn.create("duplicate-app",{appName:i})}const o=new PN(i);for(const l of Ja.values())o.addComponent(l);const a=new ID(n,r,o);return Or.set(i,a),a}function Sg(t=Vr){const e=Or.get(t);if(!e&&t===Vr&&f0())return Tg();if(!e)throw jn.create("no-app",{appName:t});return e}function ED(){return Array.from(Or.values())}async function I0(t){const e=t.name;Or.has(e)&&(Or.delete(e),await Promise.all(t.container.getProviders().map(n=>n.delete())),t.isDeleted=!0)}function gt(t,e,n){var r;let i=(r=_D[t])!==null&&r!==void 0?r:t;n&&(i+=`-${n}`);const s=i.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const a=[`Unable to register library "${i}" with version "${e}":`];s&&a.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Oi.warn(a.join(" "));return}en(new bt(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}function E0(t,e){if(t!==null&&typeof t!="function")throw jn.create("invalid-log-argument");xN(t,e)}function T0(t){DN(t)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const TD="firebase-heartbeat-database",SD=1,Za="firebase-heartbeat-store";let sf=null;function S0(){return sf||(sf=BN(TD,SD,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(Za)}}}).catch(t=>{throw jn.create("idb-open",{originalErrorMessage:t.message})})),sf}async function AD(t){try{return await(await S0()).transaction(Za).objectStore(Za).get(A0(t))}catch(e){if(e instanceof Ze)Oi.warn(e.message);else{const n=jn.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Oi.warn(n.message)}}}async function Fv(t,e){try{const r=(await S0()).transaction(Za,"readwrite");await r.objectStore(Za).put(e,A0(t)),await r.done}catch(n){if(n instanceof Ze)Oi.warn(n.message);else{const r=jn.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});Oi.warn(r.message)}}}function A0(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function DD(t){en(new bt("platform-logger",e=>new qN(e),"PRIVATE")),en(new bt("heartbeat",e=>new CD(e),"PRIVATE")),gt(Cp,Mv,t),gt(Cp,Mv,"esm2017"),gt("fire-js","")}DD("");const xD=Object.freeze(Object.defineProperty({__proto__:null,FirebaseError:Ze,SDK_VERSION:Qr,_DEFAULT_ENTRY_NAME:Vr,_addComponent:Vc,_addOrOverwriteComponent:w0,_apps:Or,_clearComponents:vD,_components:Ja,_getProvider:Ji,_registerComponent:en,_removeServiceInstance:yD,deleteApp:I0,getApp:Sg,getApps:ED,initializeApp:Tg,onLog:E0,registerVersion:gt,setLogLevel:T0},Symbol.toStringTag,{value:"Module"}));var bD="firebase",VD="10.4.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const k0=1e4,N0=`w:${Rg}`,D0="FIS_v2",GD="https://firebaseinstallations.googleapis.com/v1",KD=60*60*1e3,HD="installations",QD="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function b0({projectId:t}){return`${GD}/projects/${t}/installations`}function V0(t){return{token:t.token,requestStatus:2,expiresIn:JD(t.expiresIn),creationTime:Date.now()}}async function O0(t,e){const r=(await e.json()).error;return Li.create("request-failed",{requestName:t,serverCode:r.code,serverMessage:r.message,serverStatus:r.status})}function L0({apiKey:t}){return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":t})}function XD(t,{refreshToken:e}){const n=L0(t);return n.append("Authorization",ZD(e)),n}async function M0(t){const e=await t();return e.status>=500&&e.status<600?t():e}function JD(t){return Number(t.replace("s","000"))}function ZD(t){return`${D0} ${t}`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ex({appConfig:t,heartbeatServiceProvider:e},{fid:n}){const r=b0(t),i=L0(t),s=e.getImmediate({optional:!0});if(s){const u=await s.getHeartbeatsHeader();u&&i.append("x-firebase-client",u)}const o={fid:n,authVersion:D0,appId:t.appId,sdkVersion:N0},a={method:"POST",headers:i,body:JSON.stringify(o)},l=await M0(()=>fetch(r,a));if(l.ok){const u=await l.json();return{fid:u.fid||n,registrationStatus:2,refreshToken:u.refreshToken,authToken:V0(u.authToken)}}else throw await O0("Create Installation",l)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const U0=new Map;function $0(t,e){const n=Rh(t);B0(n,e),sx(n,e)}function B0(t,e){const n=U0.get(t);if(n)for(const r of n)r(e)}function sx(t,e){const n=ox();n&&n.postMessage({key:t,fid:e}),ax()}let yi=null;function ox(){return!yi&&"BroadcastChannel"in self&&(yi=new BroadcastChannel("[Firebase] FID Change"),yi.onmessage=t=>{B0(t.data.key,t.data.fid)}),yi}function ax(){U0.size===0&&yi&&(yi.close(),yi=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function mx({appConfig:t,heartbeatServiceProvider:e},n){const r=gx(t,n),i=XD(t,n),s=e.getImmediate({optional:!0});if(s){const u=await s.getHeartbeatsHeader();u&&i.append("x-firebase-client",u)}const o={installation:{sdkVersion:N0,appId:t.appId}},a={method:"POST",headers:i,body:JSON.stringify(o)},l=await M0(()=>fetch(r,a));if(l.ok){const u=await l.json();return V0(u)}else throw await O0("Generate Auth Token",l)}function gx(t,{fid:e}){return`${b0(t)}/${e}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function kg(t,e=!1){let n;const r=await Ph(t.appConfig,s=>{if(!q0(s))throw Li.create("not-registered");const o=s.authToken;if(!e&&vx(o))return s;if(o.requestStatus===1)return n=_x(t,e),s;{if(!navigator.onLine)throw Li.create("app-offline");const a=Ix(s);return n=yx(t,a),a}});return n?await n:r.authToken}async function _x(t,e){let n=await Wv(t.appConfig);for(;n.authToken.requestStatus===1;)await F0(100),n=await Wv(t.appConfig);const r=n.authToken;return r.requestStatus===0?kg(t,e):r}function Wv(t){return Ph(t,e=>{if(!q0(e))throw Li.create("not-registered");const n=e.authToken;return Ex(n)?Object.assign(Object.assign({},e),{authToken:{requestStatus:0}}):e})}async function yx(t,e){try{const n=await mx(t,e),r=Object.assign(Object.assign({},e),{authToken:n});return await Oc(t.appConfig,r),n}catch(n){if(x0(n)&&(n.customData.serverCode===401||n.customData.serverCode===404))await j0(t.appConfig);else{const r=Object.assign(Object.assign({},e),{authToken:{requestStatus:0}});await Oc(t.appConfig,r)}throw n}}function q0(t){return t!==void 0&&t.registrationStatus===2}function vx(t){return t.requestStatus===2&&!wx(t)}function wx(t){const e=Date.now();return e<t.creationTime||t.creationTime+t.expiresIn<e+KD}function Ix(t){const e={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},t),{authToken:e})}function Ex(t){return t.requestStatus===1&&t.requestTime+k0<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const W0="installations",Px="installations-internal",Cx=t=>{const e=t.getProvider("app").getImmediate(),n=Rx(e),r=Ji(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},kx=t=>{const e=t.getProvider("app").getImmediate(),n=Ji(e,W0).getImmediate();return{getId:()=>Tx(n),getToken:i=>Sx(n,i)}};function Nx(){en(new bt(W0,Cx,"PUBLIC")),en(new bt(Px,kx,"PRIVATE"))}Nx();gt(C0,Rg);gt(C0,Rg,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wx=30,Gx=1e3;class Kx{constructor(e={},n=Gx){this.throttleMetadata=e,this.intervalMillis=n}getThrottleMetadata(e){return this.throttleMetadata[e]}setThrottleMetadata(e,n){this.throttleMetadata[e]=n}deleteThrottleMetadata(e){delete this.throttleMetadata[e]}}const K0=new Kx;function Hx(t){return new Headers({Accept:"application/json","x-goog-api-key":t})}async function Qx(t){var e;const{appId:n,apiKey:r}=t,i={method:"GET",headers:Hx(r)},s=Vx.replace("{app-id}",n),o=await fetch(s,i);if(o.status!==200&&o.status!==304){let a="";try{const l=await o.json();!((e=l.error)===null||e===void 0)&&e.message&&(a=l.error.message)}catch{}throw $t.create("config-fetch-failed",{httpStatus:o.status,responseMessage:a})}return o.json()}async function Yx(t,e=K0,n){const{appId:r,apiKey:i,measurementId:s}=t.options;if(!r)throw $t.create("no-app-id");if(!i){if(s)return{measurementId:s,appId:r};throw $t.create("no-api-key")}const o=e.getThrottleMetadata(r)||{backoffCount:0,throttleEndTimeMillis:Date.now()},a=new Zx;return setTimeout(async()=>{a.abort()},n!==void 0?n:bx),H0({appId:r,apiKey:i,measurementId:s},o,a,e)}async function H0(t,{throttleEndTimeMillis:e,backoffCount:n},r,i=K0){var s;const{appId:o,measurementId:a}=t;try{await Xx(r,e)}catch(l){if(a)return xt.warn(`Timed out fetching this Firebase app's measurement ID from the server. Falling back to the measurement ID ${a} provided in the "measurementId" field in the local Firebase config. [${l==null?void 0:l.message}]`),{appId:o,measurementId:a};throw l}try{const l=await Qx(t);return i.deleteThrottleMetadata(o),l}catch(l){const u=l;if(!Jx(u)){if(i.deleteThrottleMetadata(o),a)return xt.warn(`Failed to fetch this Firebase app's measurement ID from the server. Falling back to the measurement ID ${a} provided in the "measurementId" field in the local Firebase config. [${u==null?void 0:u.message}]`),{appId:o,measurementId:a};throw l}const c=Number((s=u==null?void 0:u.customData)===null||s===void 0?void 0:s.httpStatus)===503?bv(n,i.intervalMillis,Wx):bv(n,i.intervalMillis),h={throttleEndTimeMillis:Date.now()+c,backoffCount:n+1};return i.setThrottleMetadata(o,h),xt.debug(`Calling attemptFetch again in ${c} millis`),H0(t,h,r,i)}}function Xx(t,e){return new Promise((n,r)=>{const i=Math.max(e-Date.now(),0),s=setTimeout(n,i);t.addEventListener(()=>{clearTimeout(s),r($t.create("fetch-throttle",{throttleEndTimeMillis:e}))})})}function Jx(t){if(!(t instanceof Ze)||!t.customData)return!1;const e=Number(t.customData.httpStatus);return e===429||e===500||e===503||e===504}class Zx{constructor(){this.listeners=[]}addEventListener(e){this.listeners.push(e)}abort(){this.listeners.forEach(e=>e())}}async function eb(t,e,n,r,i){if(i&&i.global){t("event",n,r);return}else{const s=await e,o=Object.assign(Object.assign({},r),{send_to:s});t("event",n,o)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rb{constructor(e){this.app=e}_delete(){return delete Sa[this.app.options.appId],Promise.resolve()}}let Sa={},Gv=[];const Kv={};let hf="dataLayer",ib="gtag",Hv,Q0,Qv=!1;function sb(){const t=[];if(vg()&&t.push("This is a browser extension environment."),fN()||t.push("Cookies are not available."),t.length>0){const e=t.map((r,i)=>`(${i+1}) ${r}`).join(" "),n=$t.create("invalid-analytics-context",{errorInfo:e});xt.warn(n.message)}}function ob(t,e,n){sb();const r=t.options.appId;if(!r)throw $t.create("no-app-id");if(!t.options.apiKey)if(t.options.measurementId)xt.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${t.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw $t.create("no-api-key");if(Sa[r]!=null)throw $t.create("already-exists",{id:r});if(!Qv){Ux(hf);const{wrappedGtag:s,gtagCore:o}=zx(Sa,Gv,Kv,hf,ib);Q0=s,Hv=o,Qv=!0}return Sa[r]=nb(t,Gv,Kv,e,Hv,hf,n),new rb(t)}function ab(t=Sg()){t=$(t);const e=Ji(t,Lc);return e.isInitialized()?e.getImmediate():lb(t)}function lb(t,e={}){const n=Ji(t,Lc);if(n.isInitialized()){const i=n.getImmediate();if(bc(e,n.getOptions()))return i;throw $t.create("already-initialized")}return n.initialize({options:e})}function ub(t,e,n,r){t=$(t),eb(Q0,Sa[t.app.options.appId],e,n,r).catch(i=>xt.error(i))}const Yv="@firebase/analytics",Xv="0.10.0";function cb(){en(new bt(Lc,(e,{options:n})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("installations-internal").getImmediate();return ob(r,i,n)},"PUBLIC")),en(new bt("analytics-internal",t,"PRIVATE")),gt(Yv,Xv),gt(Yv,Xv,"esm2017");function t(e){try{const n=e.getProvider(Lc).getImmediate();return{logEvent:(r,i,s)=>ub(n,r,i,s)}}catch(n){throw $t.create("interop-component-reg-failed",{reason:n})}}}cb();/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hb{constructor(e,n){this._delegate=e,this.firebase=n,Vc(e,new bt("app-compat",()=>this,"PUBLIC")),this.container=e.container}get automaticDataCollectionEnabled(){return this._delegate.automaticDataCollectionEnabled}set automaticDataCollectionEnabled(e){this._delegate.automaticDataCollectionEnabled=e}get name(){return this._delegate.name}get options(){return this._delegate.options}delete(){return new Promise(e=>{this._delegate.checkDestroyed(),e()}).then(()=>(this.firebase.INTERNAL.removeApp(this.name),I0(this._delegate)))}_getService(e,n=Vr){var r;this._delegate.checkDestroyed();const i=this._delegate.container.getProvider(e);return!i.isInitialized()&&((r=i.getComponent())===null||r===void 0?void 0:r.instantiationMode)==="EXPLICIT"&&i.initialize(),i.getImmediate({identifier:n})}_removeServiceInstance(e,n=Vr){this._delegate.container.getProvider(e).clearInstance(n)}_addComponent(e){Vc(this._delegate,e)}_addOrOverwriteComponent(e){w0(this._delegate,e)}toJSON(){return{name:this.name,automaticDataCollectionEnabled:this.automaticDataCollectionEnabled,options:this.options}}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Y0(){const t=fb(hb);t.INTERNAL=Object.assign(Object.assign({},t.INTERNAL),{createFirebaseNamespace:Y0,extendNamespace:e,createSubscribe:g0,ErrorFactory:Jn,deepExtend:xc});function e(n){xc(t,n)}return t}const pb=Y0();/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rt(t,...e){throw xg(t,...e)}function et(t,...e){return xg(t,...e)}function Z0(t,e,n){const r=Object.assign(Object.assign({},Tb()),{[e]:n});return new Jn("auth","Firebase",r).create(e,{appName:t.name})}function Eo(t,e,n){const r=n;if(!(e instanceof r))throw r.name!==e.constructor.name&&rt(t,"argument-error"),Z0(t,"argument-error",`Type of ${e.constructor.name} does not match expected instance.Did you pass a reference from a different Auth SDK?`)}function xg(t,...e){if(typeof t!="string"){const n=e[0],r=[...e.slice(1)];return r[0]&&(r[0].appName=t.name),t._errorFactory.create(n,...r)}return J0.create(t,...e)}function P(t,e,...n){if(!t)throw xg(e,...n)}function Tn(t){const e="INTERNAL ASSERTION FAILED: "+t;throw Hu(e),new Error(e)}function dn(t,e){t||Tn(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
