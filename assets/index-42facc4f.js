 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function rf(t,e){return Jn(t,"POST","/v1/accounts:signInWithPassword",Ce(t,e))}async function Th(t,e){return xe(t,"POST","/v1/accounts:sendOobCode",Ce(t,e))}async function Nx(t,e){return Th(t,e)}async function sf(t,e){return Th(t,e)}async function of(t,e){return Th(t,e)}async function Dx(t,e){return Th(t,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function bx(t,e){return Jn(t,"POST","/v1/accounts:signInWithEmailLink",Ce(t,e))}async function xx(t,e){return Jn(t,"POST","/v1/accounts:signInWithEmailLink",Ce(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Bn(t,e){return Jn(t,"POST","/v1/accounts:signInWithIdp",Ce(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ox(t,e){return xe(t,"POST","/v1/accounts:sendVerificationCode",Ce(t,e))}async function Lx(t,e){return Jn(t,"POST","/v1/accounts:signInWithPhoneNumber",Ce(t,e))}async function Mx(t,e){const n=await Jn(t,"POST","/v1/accounts:signInWithPhoneNumber",Ce(t,e));if(n.temporaryProof)throw ia(t,"account-exists-with-different-credential",n);return n}const Fx={USER_NOT_FOUND:"user-not-found"};async function Ux(t,e){const n=Object.assign(Object.assign({},e),{operation:"REAUTH"});return Jn(t,"POST","/v1/accounts:signInWithPhoneNumber",Ce(t,n),Fx)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function qu(t,e){return Jn(t,"POST","/v1/accounts:signUp",Ce(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Gx(t,e){return Jn(t,"POST","/v1/accounts:signInWithCustomToken",Ce(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Z$(t){J$(t,(e,n)=>new UR(e,n,new H$)),t.registerVersion(W$,G$)}Z$(Xn);const e4={apiKey:"AIzaSyDmeCKj1u6joV57Opj22FUUvQCbgaW7qtI",authDomain:"squarelion-43d29.firebaseapp.com",projectId:"squarelion-43d29",storageBucket:"squarelion-43d29.appspot.com",messagingSenderId:"171439211836",appId:"1:171439211836:web:5aba3918d87876d0d84a39",measurementId:"G-9S8TZFG63M"},qR=Xn.initializeApp(e4);Cb(qR);Xn.auth();const PI=Xn.firestore();e$(qR);Xn.firestore();function t4({name:t,setName:e,setMiddle:n}){const r=async()=>{try{return PI.collection("TempName").orderBy("timestamp","desc").limit(1).onSnapshot(o=>{const a=o.docs.map(l=>({id:l.id,...l.data()}));e(a)})}catch(s){console.error("Error fetching message data:",s)}};Cr.useEffect(()=>{r()},[]);const i=async()=>{try{return PI.collection("Temp").orderBy("timestamp","desc").limit(1).onSnapshot(o=>{const a=o.docs.map(l=>({id:l.id,...l.data()}));n(a)})}catch(s){console.error("Error fetching message data:",s)}};Cr.useEffect(()=>{i()},[])}function n4(){const[t,e]=Cr.useState([]),[n,r]=Cr.useState([]);return ye.jsxs("div",{className:"w-1/2",children:[ye.jsx(t4,{name:t,setName:e,setMiddle:r}),ye.jsx("section",{className:"mt-10 mb-10 ml-5 text-white drop-shadow-xl ",children:t.map((i,s)=>ye.jsxs("h1",{className:"text-6xl  drop-shadow-xl",children:[" Hello, ",i.Name===0?"":i.Name," "]},s))}),ye.jsx("br",{}),ye.jsx("hr",{className:"w-[50vw] border-yellow-500 border-b-4"}),ye.jsx("section",{className:"mt-10 mb-10 ml-5 text-white drop-shadow-xl",children:n.map((i,s)=>ye.jsxs("div",{className:"text-2xl",children:[ye.jsxs("li",{className:" drop-shadow-xl",children:[i.Name," "]}),ye.jsx("li",{className:" drop-shadow-xl",children:i.Location}),ye.jsx("li",{className:" drop-shadow-xl",children:i.description})]},s))})]})}const r4="https://Balanss.github.io/Bot/assets/Lionbot-913218f9.png";function i4(){return ye.jsx("div",{className:"bg-white border-b-4 border-yellow-500 dark:bg-gray-900 ",children:ye.jsxs("div",{className:"",children:[ye.jsxs("div",{className:"pt-2 pl-2",children:[ye.jsx("img",{src:r4,alt:"Lion",className:"w-16 h-16 rounded-2xl"})," "]}),ye.jsx("div",{className:"text-center text-3xl text-white",children:ye.jsx("h1",{children:"SQUARELION AGENCY"})})]})})}function s4(){return Cr.useState(0),ye.jsxs("div",{children:[ye.jsx(i4,{}),ye.jsx(n4,{})]})}Af.createRoot(document.getElementById("root")).render(ye.jsx(lP.StrictMode,{children:ye.jsx(s4,{})}));
